  ...
  tournaments: [
    {
      ...
      sumsCleanly: true,
      events: [
        { n:1,  name:"Skeet Shooting",     short:"Skeet",      day:"Fri", time:"5:30pm", t:17.5*60, venue:"American Shooting Center", icon:"../images/badges/badge-Skeet.png",
        ...
        { n:2,  name:"Golden Tee",         short:"Golden Tee", day:"Fri", time:"9:00pm", t:21*60,   venue:"Stars Sports Bar", icon:"../images/badges/badge-GoldenTee.png",
        ...
        { n:5,  name:"Home Run Derby",     short:"Derby",      day:"Sat", time:"9:00am", t:9*60,    venue:"George Bush Park", icon:"../images/badges/badge-HomeRunDerby.png",
        ...
        { n:7,  name:"Field Goal Kicking", short:"Field Goal", day:"Sat", time:"2:00pm", t:14*60,   venue:"Beck Jr. High", icon:"../images/badges/badge-FieldGoal.png",
        ...
        { n:8,  name:"Shuriken",           short:"Shuriken",   day:"Sat", time:"4:00pm", t:16*60,   venue:"Bateman House", icon:"../images/badges/badge-Shuriken.png",
        ...
        { n:9,  name:"Corn Hole",          short:"Corn Hole",  day:"Sat", time:"5:00pm", t:17*60,   venue:"Bateman House", icon:"../images/badges/badge-CornHole.png", pair:true,
          basis:"Tournament", rules:"5-team single elimination, teams ordered by current standings.", snafu:null },
        { n:10, name:"Beer Pong",          short:"Beer Pong",  day:"Sat", time:"7:00pm", t:19*60,   venue:"Bateman House", icon:"../images/badges/badge-BeerPong.png", pair:true,
          basis:"Tournament", rules:"5-team single elimination, teams ordered by current standings.", snafu:null }
      ],
      players: [
...

    {
      ...
      events: [
        { n:1,  name:"Skeet Shooting",     short:"Skeet",      day:"Day 1", venue:"American Shooting Center", icon:"../images/badges/badge-Skeet.png", basis:"Most targets hit" },
        { n:2,  name:"Home Run Derby",     short:"Derby",      day:"Day 1", venue:null, icon:"../images/badges/badge-HomeRunDerby.png", basis:"Most home runs" },
        { n:3,  name:"Shuffle Board",      short:"Shuffle",    day:"Day 1", venue:null, icon:"../images/D2-Shuffleboard.png", basis:"Most points", pair:true },
        { n:4,  name:"Washers",            short:"Washers",    day:"Day 1", venue:null, icon:"../images/badges/badge-Washers.png", basis:"Most points", pair:true },
        ...
        { n:7,  name:"Field Goal Kicking", short:"Field Goal", day:"Day 2", venue:null, icon:"../images/badges/badge-FieldGoal.png", basis:"Furthest kick" },
        { n:8,  name:"Corn Hole",          short:"Corn Hole",  day:"Day 2", venue:null, icon:"../images/badges/badge-CornHole.png", basis:"Tournament", pair:true },
        { n:9,  name:"Kan Jam",            short:"Kan Jam",    day:"Day 2", venue:null, icon:"../images/badges/badge-KanJam.png", basis:"Tournament", pair:true },
        { n:10, name:"Beer Pong",          short:"Beer Pong",  day:"Day 2", venue:null, icon:"../images/badges/badge-BeerPong.png", basis:"Tournament", pair:true }
      ],
      players: [
...

    {
      ...
      events: [
        { n:1,  name:"Skeet Shooting",     short:"Skeet",      day:"Fri", time:"5:00pm",  t:17*60,   venue:"American Shooting Centers", icon:"../images/badges/badge-Skeet.png",
        ...
        { n:2,  name:"Home Run Derby",     short:"Derby",      day:"Fri", time:"7:00pm",  t:19*60,   venue:"West Oaks Little League Fields", icon:"../images/badges/badge-HomeRunDerby.png",
        ...
        { n:3,  name:"Washers",            short:"Washers",    day:"Fri", time:"9:00pm",  t:21*60,   venue:"Rosenberger Construction", icon:"../images/badges/badge-Washers.png", pair:true,
        ...
        { n:5,  name:"Disc Golf",          short:"Disc Golf",  day:"Sat", time:"10:00am", t:10*60,   venue:"WFDD Park", icon:"../images/badges/badge-DiscGolf.png",
        ...
        { n:6,  name:"Field Goal Kicking", short:"Field Goal", day:"Sat", time:"12:00pm", t:12*60,   venue:"Cinco Ranch High School", icon:"../images/badges/badge-FieldGoal.png",
        ...
        { n:8,  name:"Kan Jam",            short:"Kan Jam",    day:"Sat", time:"7:00pm",  t:19*60,   venue:"Bateman House", icon:"../images/badges/badge-KanJam.png", pair:true,
        ...
        { n:9,  name:"Corn Hole",          short:"Corn Hole",  day:"Sat", time:"7:00pm",  t:19*60,   venue:"Bateman House", icon:"../images/badges/badge-CornHole.png", pair:true,
          basis:"Single elimination tournament", rules:"Team on the same board side. All 4 in = instant win.", snafu:null },
        { n:10, name:"Beer Pong",          short:"Beer Pong",  day:"Sat", time:"9:00pm",  t:21*60,   venue:"Bateman House", icon:"../images/badges/badge-BeerPong.png", pair:true,
...

    {
      ...
      events: [
        { n:1,  name:"Skeet Shooting",    short:"Skeet",      day:"Fri", venue:"Vacek Ranch", icon:"../images/badges/badge-Skeet.png", basis:"Most targets hit",
          rules:"Hand throwers used for a rustic angle. Bateman scored a perfect 25." },
        { n:2,  name:"Home Run Derby",    short:"Derby",      day:"Fri", venue:"Vacek Ranch", icon:"../images/badges/badge-HomeRunDerby.png", basis:"Most home runs" },
        { n:3,  name:"Washers",           short:"Washers",    day:"Fri", venue:"Vacek Ranch", icon:"../images/badges/badge-Washers.png", basis:"Most points", pair:true },
        { n:4,  name:"Long Golf Ball",    short:"Long Drive", day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-LongDrive.png", basis:"Furthest drive", newThisYear:true },
        { n:5,  name:"Disc Golf",         short:"Disc Golf",  day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-DiscGolf.png", basis:"Total strokes" },
        { n:6,  name:"Shooting Gallery",  short:"Gallery",    day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-Shooting.png", basis:"Most targets hit",
          rules:"Shot from the country back patio.", newThisYear:true },
        { n:7,  name:"Shuriken",          short:"Shuriken",   day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-Shuriken.png", basis:"Highest score",
          rules:"Returned after being banned in late 2015 over neighbor concerns." },
        { n:8,  name:"Corn Hole",         short:"Corn Hole",  day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-CornHole.png", basis:"Tournament", pair:true },
        { n:9,  name:"Kan Jam",           short:"Kan Jam",    day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-KanJam.png", basis:"Tournament", pair:true },
        { n:10, name:"Beer Pong",         short:"Beer Pong",  day:"Sat", venue:"Vacek Ranch", icon:"../images/badges/badge-BeerPong.png", basis:"Tournament", pair:true }
      ],
      players: [
...

    {
      ...
      events: [
        { n:1,  name:"Skeet Shooting",  short:"Skeet",      day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-Skeet.png", basis:"Most targets hit" },
        { n:2,  name:"Home Run Derby",  short:"Derby",      day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-HomeRunDerby.png", basis:"Most home runs" },
        { n:3,  name:"Washers",         short:"Washers",    day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-Washers.png", basis:"Most points", pair:true },
        { n:4,  name:"Disc Golf",       short:"Disc Golf",  day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-DiscGolf.png", basis:"Total strokes" },
        { n:5,  name:"Kan Jam",         short:"Kan Jam",    day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-KanJam.png", basis:"Tournament", pair:true },
        { n:6,  name:".22 Shoot",       short:".22 Shoot",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-Shooting.png", basis:"Most targets hit" },
        { n:7,  name:"Long Drive",      short:"Long Drive", day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-LongDrive.png", basis:"Furthest drive" },
        { n:8,  name:"Chinese Stars",   short:"Stars",      day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-Shuriken.png", basis:"Highest score",
          rules:"The Shuriken event under its other name." },
        { n:9,  name:"Corn Hole",       short:"Corn Hole",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-CornHole.png", basis:"Tournament", pair:true },
        { n:10, name:"Beer Pong",       short:"Beer Pong",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-BeerPong.png", basis:"Tournament", pair:true }
      ],
      players: [
...

    {
      ...
      totals: { "Cameron Brown":76, "Andy Conacher":72, "Duane Vacek":69, "Ben Murrill":68,
                ...
                "Carlos Quinteros":34 },
      events: [
        { n:1,  name:"Skeet Shooting", short:"Skeet",      day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-Skeet.png", basis:"Most targets hit", gameMaster:"Bateman" },
        { n:2,  name:"Home Run Derby", short:"Derby",      day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-HomeRunDerby.png", basis:"Most home runs", gameMaster:"Quinteros" },
        { n:3,  name:"Washers",        short:"Washers",    day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-Washers.png", basis:"Most points", pair:true, gameMaster:"East" },
        { n:4,  name:"Kan Jam",        short:"Kan Jam",    day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-KanJam.png", basis:"Tournament", pair:true, gameMaster:"Duane Vacek" },
        { n:5,  name:"Corn Hole",      short:"Corn Hole",  day:"Day 1", venue:"Vacek Ranch", icon:"../images/badges/badge-CornHole.png", basis:"Tournament", pair:true, gameMaster:"Brown" },
        { n:6,  name:".22 Shoot",      short:".22 Shoot",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-Shooting.png", basis:"Most targets hit", gameMaster:"Wall" },
        { n:7,  name:"Long Drive",     short:"Long Drive", day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-LongDrive.png", basis:"Furthest drive", gameMaster:"Murrill" },
        { n:8,  name:"Disc Golf",      short:"Disc Golf",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-DiscGolf.png", basis:"Total strokes", gameMaster:"Wall" },
        { n:9,  name:"Kickball",       short:"Kickball",   day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-Kickball.png", basis:"Tournament", gameMaster:"Brown", newThisYear:true },
        { n:10, name:"Beer Pong",      short:"Beer Pong",  day:"Day 2", venue:"Vacek Ranch", icon:"../images/badges/badge-BeerPong.png", basis:"Tournament", pair:true, gameMaster:"Dan Vacek" }
      ],
      players: [
